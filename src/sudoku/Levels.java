...
public class Levels extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        SolveRandomGui s=new SolveRandomGui(ss,50);
        if(ss.isValidSudoku()) {s.setVisible(true); this.dispose();}
        else JOptionPane.showMessageDialog(null, "Try Aganin !!");
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
               SudokuSolver ss=new SudokuSolver();
        SolveRandomGui s=new SolveRandomGui(ss,60);
        if(ss.isValidSudoku()) {s.setVisible(true); this.dispose();}
        else JOptionPane.showMessageDialog(null, "Try Aganin !!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SudokuSolver ss=new SudokuSolver();
        SolveRandomGui s=new SolveRandomGui(ss,40);
        if(ss.isValidSudoku()) {s.setVisible(true); this.dispose();}
        else JOptionPane.showMessageDialog(null, "Try Aganin !!");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
                  SudokuSolver ss=new SudokuSolver();
        SolveRandomGui s=new SolveRandomGui(ss,70);
        if(ss.isValidSudoku()) {s.setVisible(true); this.dispose();}
        else JOptionPane.showMessageDialog(null, "Try Aganin !!");
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        StartModes s=new StartModes();
        s.setVisible(true);
        this.dispose();
